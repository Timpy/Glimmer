...
public class DataRSSToNTuples {
	...
	// For some really strange reason this appears empty when accessed in
	// convert()
    ...
    public void convert(URL url, String data, boolean removeDatatypes, RDFHandler handler) throws IOException, TransformerConfigurationException,
	    TransformerException, RDFParseException, RDFHandlerException {
    ...
    public String convert(URL url, String data, String adjunctid, boolean removeDatatypes, boolean nTriples) throws IOException,
	    TransformerConfigurationException, TransformerException, RDFParseException, RDFHandlerException {
