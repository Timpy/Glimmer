	 ...
	 public static String getTaskId(Configuration conf) throws IllegalArgumentException
	   {
		...
		public static class MapClass extends 
			...
			public void setup(Context context) {
				...
				try {
					...
					builder = new SimpleCompressedDocumentCollectionBuilder(
							"collection-", new IdentityDocumentFactory(), true);
		...
		private void printUsage() {
			System.out
					.println("Usage : BySubjectCollectionBuilder <input_dir> <output_dir>");
		}
