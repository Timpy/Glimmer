...
/**
 * This class takes a directory of files containing compressed rdf files.  It converts them
 * into TrecWeb format.  
 * 
 * Note: This assumes that the triples are sorted by subject.  The RDF attributes are mapped
 * onto SGML tags and the RDF objects are the contents of the tag.  
 * 
 * This is was written for the UMass participation in the Semsearch Evaluation workshop.  It
 * is open source code, available on Github, https://github.com/daltonj/CIIRShared
 * 
 * @author jdalton
 *
 */
public class RDFtoTrecWebConverter {
	 ...
	 * @throws Exception
	 */
	public void attributesToXml(String subject, StatementCollectorHandler handler) 
	throws Exception {
	...
	protected StatementCollectorHandler parseStatements(String url, String data) 
	throws Exception {
		...
		for (String line: lines) {
			...
			//System.out.println("TRIPLE: " + new StatementImpl(subject, predicate, object));
