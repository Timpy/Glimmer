	...
	public static class ReduceClass extends MapReduceBase implements
		...
		public void configure(JobConf job) {
			...
			try {
				...
				collection = new SimpleCompressedDocumentCollectionBuilder(
						"triples-", new IdentityDocumentFactory(), true);
		...
		public void reduce(Text key, Iterator<Text> values,
			...
			collection.startDocument(key.toString(), key.toString()); //title and uri are both the URI
			int count =0;
...
*/
	...
	private void printUsage() {
		System.out
				.println("Usage : TriplesCollectionBuilder <input_dir> <output_dir>");
	}
