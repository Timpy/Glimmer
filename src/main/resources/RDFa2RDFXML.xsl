...
<variable name='xhtml_base' select="//*/h:head/h:base[position()=1]/@href"/>
...
<variable name='this' >
	<choose>
		...
		<when test="string-length($xhtml_base)>0"><value-of select="$xhtml_base"/></when>
